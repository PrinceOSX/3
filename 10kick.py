...
╠selfbot by ~`•NONAME•×บอท
╠════════════════════
╚════[ รัปประกันความพึงพอใจ ]

""",
    "message1":"บัญชีนี้ถูกป้องกันโดย Selfbot [BY.~`•NONAME•×บอท]ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ[BY.มินทีมทดลองบอท]ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("[BY.×•NONAME•×]",mi_d)
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("NONAME HACK SELFBOT", mi_d)
                    line.sendText(msg.to,"NONAME HACK BOT")
                    line.createGroup("NONAME HACK SELFBOT", mi_d)
                    line.sendText(msg.to,"NONAME HACK BOT")
                        ...
                        line.createGroup("NONAME HACK SELFBOT Group",[key])
                        line.sendText(msg,to,"NONAME HACK SELFBOT")
